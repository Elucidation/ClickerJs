  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        'Autoclicking at ',
        this.props.clickDelta.toFixed(0),
...
var ClickButton = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'button',
      { type: 'button', onClick: this.props.submitClick },
      'Click me'
    );
  }
});
    ...
    var upgradeButtons = this.props.upgradeFullList.map(function (upgrade, i) {
      ...
      if (state.upgrades[i] > 0 || state.clicks >= upgrade.minclicks) {
        return React.createElement(
          'li',
          { key: upgrade.id },
          React.createElement(UpgradeButton, { key: upgrade.id,
...
var ClickerWindow = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'clickerWindow' },
      React.createElement(
        'h1',
        null,
        'Clicker Game'
      ),
      React.createElement(ClickCounter, { clicks: this.state.clicks, clickDelta: delta }),
      React.createElement(ClickButton, { submitClick: this.handleClick }),
      React.createElement(ClickButtonUpgrades, { upgradeFullList: this.props.upgradeFullList,
        state: this.state,
...
ReactDOM.render(React.createElement(ClickerWindow, { upgradeFullList: buttonUpgradeFullList, updateInterval: autoclickUpdateRate }), document.getElementById('content'));
